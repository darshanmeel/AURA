...
-- Turn source:      int_turns (assistant_ts = when the turn completed)
...
SELECT
    ...
    -- Projected full-day cost at current hourly rate
    COALESCE(tc.today_cost, 0.0) / he.h * 24.0           AS today_pace_hourly,
