...
- **KPI strip** — 7 metric tiles: active sessions, cache hit rate, tool calls, commits, errors, **budget-killed** (count of `session_status='budget_killed'` sessions in range), projected 30d cost
